        ...
        <div class="invoice">
            <div class="invoice-header">
                <div class='invoice-info'>
                    ...
                    <h2>Payslip for the Month of 2023</h2>
                </div>
                ...
                <div class="invoice-info">
                    <asp:Panel ID="Panel1" runat="server">
                        <table>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:dbconn %>" SelectCommand="SELECT LeaveID, Reason, FromDate, ToDate FROM LeaveApplications WHERE UserID = @UserID">
                                <SelectParameters>
                                    <asp:Parameter Name="UserID" Type="Int32" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:dbconn %>" SelectCommand="SELECT LeaveID, Reason, FromDate, ToDate FROM LeaveApplications WHERE UserID = @UserID">
                                <SelectParameters>
                                    <asp:Parameter Name="UserID" Type="Int32" />
                                </SelectParameters>
                            </asp:SqlDataSource>
